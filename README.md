...
> end-to-end against real Postgres. ADRs 0001–0178 are drafted in
...
```
CrossEngin/
├── docs/             vision + ADRs 0001-0178  (CC BY 4.0)
│   ├── vision.md
...
- **Human contributor?** Start with **[`docs/vision.md`](docs/vision.md)**
  ...
  index of 178 architecture decisions). Individual ADRs live at
...
The 49 integration tests in `apps/workflow-worker` + `apps/operate-server`

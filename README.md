...
> M3.5 + M3.6 + M3.7 + M4 + M4.5 + M4.6 + M4.7 + M4.7.5 + M4.7.6 + M4.8 + M4.8.x + M4.8.y + M5 + M5.5 + M5.6 +
...
> all green, zero type errors. ADRs 0001–0081 fully drafted.
...
running index of 81 architecture decisions.

...
> **Status:** Phase 2 M1 + M2 + M2.5 + M2.6 + M2.7 + M2.8 + M2.9 + M2.9.5 + M2.9.6 + M2.9.7 + M3 +
...
> under a real schema.
> **55 packages + 1 app, 119 meta-schema tables, 6,396 tests**,
> all green, zero type errors. ADRs 0001–0077 fully drafted.

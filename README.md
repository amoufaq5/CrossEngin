...
> end-to-end against real Postgres. ADRs 0001–0171 are drafted in
...
```
CrossEngin/
├── docs/             vision + ADRs 0001-0171  (CC BY 4.0)
│   ├── vision.md
...
- **Human contributor?** Start with **[`docs/vision.md`](docs/vision.md)**
  ...
  index of 171 architecture decisions). Individual ADRs live at

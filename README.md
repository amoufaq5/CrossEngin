...
> M2.8.5 + M5.7 + M5.8 + M6 + M6.5 + M6.5.5 + M7 + M7-wire landed. The four runtime pillars (DDL + crypto
...
> under a real schema.
> **52 packages + 1 app, 119 meta-schema tables, 5,907 tests**,
> all green, zero type errors. ADRs 0001–0063 fully drafted.
> `crossengin apply --dry-run --pack=operate-erp/core` produces
> the META bootstrap SQL + 4 ERP entity tables in one command. M1
...
running index of 63 architecture decisions.

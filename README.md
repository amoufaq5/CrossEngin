...
> under a real schema.
> **56 packages + 1 app, 129 meta-schema tables, 9,440 tests**,
> all green, zero type errors — in src AND in `*.test.ts` files.
> ADRs 0001–0249 fully drafted.

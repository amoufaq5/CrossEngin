...
> **Status:** Phase 2 M1 + M2 + M2.5 + M2.6 + M2.7 + M2.8 + M2.9 + M3 +
...
> under a real schema.
> **55 packages + 1 app, 119 meta-schema tables, 6,214 tests**,
> all green, zero type errors. ADRs 0001–0071 fully drafted.

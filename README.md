...
> M2.8.5 + M5.7 + M5.8 + M5.9 + M6 + M6.5 + M6.5.5 + M7 + M7-wire + M7.5 + M7.7 + M7.8 landed. The four runtime pillars (DDL + crypto
...
> under a real schema.
> **53 packages + 1 app, 119 meta-schema tables, 6,003 tests**,
> all green, zero type errors. ADRs 0001–0067 fully drafted.

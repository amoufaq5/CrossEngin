...
> end-to-end against real Postgres. ADRs 0001–0168 are drafted in
...
```
CrossEngin/
├── docs/             vision + ADRs 0001-0168  (CC BY 4.0)
│   ├── vision.md
...
- **Human contributor?** Start with **[`docs/vision.md`](docs/vision.md)**
  ...
  index of 168 architecture decisions). Individual ADRs live at

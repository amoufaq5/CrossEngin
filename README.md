...
> M3.5 + M3.6 + M3.7 + M4 + M4.5 + M4.6 + M4.7 + M4.7.5 + M4.7.6 + M5 + M5.5 + M5.6 +
...
> under a real schema.
> **55 packages + 1 app, 119 meta-schema tables, 6,425 tests**,
> all green, zero type errors. ADRs 0001–0078 fully drafted.

...
- **`operate-web`** — Phase 3 P3.1: a framework-neutral,
  ...
  `views`. 4 modules (model / viewer / compile / report-exec): model (serializable zod descriptors —

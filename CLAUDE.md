...
genuinely green against a live Postgres** — no type errors. **P5 (ADR-0081) began the marketplace install runtime** — a new
...
- **`marketplace-pg`** — Phase 3 P5: the marketplace install runtime over the
  ...
  Deps: `marketplace` + `kernel-pg`. Offline-tested with a fake `PgConnection`.

...
- **`dr-runtime`** — Phase 3 P8: the runtime over the `dr` contracts (pure, no
  ...
  + key rotation, the live SLO loop, scheduled access reviews, and a PG sibling for
  failover/drill records are the remaining P8 increments.

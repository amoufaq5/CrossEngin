...
- **`operate-web`** — Phase 3 P3.1: a framework-neutral,
  ...
  it compiles). Pure rendering over existing stores — no new META_ tables;
  covers 6 of 8 manifest view kinds (dashboard/pivot deferred).

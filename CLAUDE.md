...
- **`active-active-runtime-pg`** — Phase 3 P6.4: the Postgres sibling for the
  ...
  A recurring writer + a verify/read CLI are the follow-ups.
...
P3.49 / ADR-0204), all failing the build).

...
genuinely green against a live Postgres** — no type errors. **P5.10 (ADR-0216)
...
- **`kernel-pg`** — Postgres-backed migration applier (first
  ...
  for LISTEN/NOTIFY, since LISTEN is connection-scoped), statement-hash

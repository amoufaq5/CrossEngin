...
genuinely green against a live Postgres** — no type errors. **P5.5 (ADR-0211) wired per-tenant gateway dispatch** — installing a pack now actually

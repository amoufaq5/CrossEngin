...
all green, no type errors. M2.X.5.aa.z adds full OpenAI Files
...
ADRs 0001-0102 are fully drafted in `docs/adr/` — no reserved
...
ADRs 0001-0102 exist as markdown in `docs/adr/`. Every shipped

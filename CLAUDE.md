...
- **`marketplace-pg`** — Phase 3 P5: the marketplace install runtime over the
  ...
  install half of the P7 exit criterion). Deps: `marketplace` + `kernel-pg`. Offline-tested
  with a fake `PgConnection` + a gated PG test.

...
P1.27 + P1.28 + P2.18 + P2.19 + P2.20 + P2.21 + P2.22 + P2.23 + P2.24** landed: **61 packages + 3 apps, 124
meta-schema tables, 6,595 offline tests + 27 gated real-Postgres
integration tests (16 worker + 11 operate-server)**, all green, no type
errors. (Earlier
...
acknowledged → mitigated → resolved). **P2.14 (ADR-0118) added a projection
...
- **`apps/workflow-worker`** — Phase 3 P2.3: the runnable
  ...
  acked_at/mitigated_at — so metrics also report MTTA/MTTM). All logic

...
- **`operate-runtime`** — Phase 3 P1 serving keystone: composes a
  ...
  [+ schemaToTsType / operationMethodName] — a pure OpenAPI→TS client emitter, one
  self-contained module of typed interfaces + a createOperateClient fetch factory),
  compile

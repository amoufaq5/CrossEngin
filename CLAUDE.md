...
P1.27 + P1.28 + P2.18 + P2.19 + P2.20 + P2.21 + P2.22 + P2.23 + P2.24 + P2.25 + P2.26 + P2.27 + P2.28** landed: **61 packages + 3 apps, 124
meta-schema tables, 6,604 offline tests + 27 gated real-Postgres
...
working transport. **P2.14 (ADR-0118) added a projection

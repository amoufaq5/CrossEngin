...
genuinely green against a live Postgres** — no type errors. **P7 (ADR-0084) opened the
...
- **`ai-architect-runtime`** — Phase 3 P7: the pure runtime composing the
  ...
  Dep `@crossengin/ai-architect`. Detecting a refusal from a manifest diff +
  wiring into architect-cli's approval path + the agent→marketplace-pg
  publish/install are the follow-ups.

...
P1.27 + P1.28 + P2.18 + P2.19 + P2.20 + P2.21 + P2.22 + P2.23 + P2.24 + P2.25 + P2.26 + P2.27 + P2.28 + P2.29 + P2.30 + P2.31 + P2.32 + P2.33 + P2.34 + P2.35 + P2.36 + P2.37 + P2.38 + P2.39 + P2.40 + P2.41 + P2.42 + P2.43 + P2.44 + P3.1 + P2.45 + P3.2 + P3.3 + P3.4 + P2.46 + P3.5 + P2.48 + P2.47 + P2.49 + P3.6 + P3.7 + P3.8 + P3.9 + P3.10 + P3.11 + P3.12** landed: **64 packages + 4 apps, 125
meta-schema tables, 6,975 offline tests + 46 gated real-Postgres
...
- **`operate-web-react`** — Phase 3 P3.3: a React component
  ...
  (DetailView + Edit link / Delete button gated by the server flags). Fetch +
  navigation are injectable so tests stay DOM-free. No new META_ tables.

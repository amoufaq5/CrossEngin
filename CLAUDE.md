...
genuinely green against a live Postgres** — no type errors. **P7.2 (ADR-0226)
...
- **`ai-architect-runtime`** — Phase 3 P7: the pure runtime composing the
  ...
  the gate). Deps `@crossengin/ai-architect` + `@crossengin/types`. Wiring into
  architect-cli's approval path + the agent→marketplace-pg publish/install are the
  follow-ups.

...
- **`operate-web`** — Phase 3 P3.1: a framework-neutral,
  ...
  fields the viewer can't read are dropped]; pure data,
  the parity sibling of operate-runtime's api-descriptor):

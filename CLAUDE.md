...
- **`operate-runtime`** — Phase 3 P1 serving keystone: composes a
  ...
  RBAC + redaction), api-descriptor + openapi (P3.26: ApiDescriptor =
  ...
  served doc to the caller's grantable operations), compile

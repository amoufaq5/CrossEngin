...
genuinely green against a live Postgres** — no type errors. **P5.4 (ADR-0210) added per-tenant route composition** — turning the resolved surface

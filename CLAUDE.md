...
genuinely green against a live Postgres** — no type errors. **P6 (ADR-0083) opened the
...
- **`active-active-runtime`** — Phase 3 P6: the runtime over the
  ...
  pinned data/AI + an `edge-runtime` region-router + a PG persistence
  sibling are the follow-ups.

...
- **`operate-web`** — Phase 3 P3.1: a framework-neutral,
  ...
  `views`. 6 modules (model / viewer / compile / report-exec / describe /
  model-schema; P3.35/ADR-0190 model-schema = zodToOpenApiSchema [a focused

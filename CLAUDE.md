...
P1.27 + P1.28 + P2.18 + P2.19 + P2.20 + P2.21 + P2.22 + P2.23** landed: **61 packages + 3 apps, 124
meta-schema tables, 6,589 offline tests + 26 gated real-Postgres
...
incident timeline now yields real ops KPIs. **P2.14 (ADR-0118) added a projection
...
- **`apps/workflow-worker`** — Phase 3 P2.3: the runnable
  ...
  per-severity gauges + escalation totals over the timeline). All logic

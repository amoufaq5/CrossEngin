...
export function helpText(): string {
  return [
    ...
    "                          retention_set|policy_deleted — invalid value exits 2. With",
    ...
    "                          --actor-id + --actor-id-not + --kind all repeatable for",
    "                          OR-semantic multi-value filters. --system-only / --no-system",

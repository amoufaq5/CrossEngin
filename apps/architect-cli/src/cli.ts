...
export function helpText(): string {
  return [
    ...
    "                          offending side(s).",
    "                          --kind-a / --kind-b assert side A / side B (independently)",
    "                          has that kind; per-side fires independently of --kind global",
    "                          expectation and after it in the check order. --kind-not is",
    ...
    "                          --actor-id-a / --actor-id-b assert side A / side B has that",
    "                          actor; per-side fires independently. --actor-id-not is",
    ...
    "                          --actor-id-not-b are per-side exclusions on each side.",

...
export function helpText(): string {
  return [
    ...
    "                          with null actor_id are included). --kind is repeatable (same",
    "                          OR semantic) across opt_out_set|opt_out_cleared|retention_set|",
    "                          policy_deleted — invalid value exits 2. With --after-id:",
    "                          cursor forward in time (newer entries since diff-timeline is",
    "                          ASC). With --before-id: cursor backward toward older entries.",
    "                          --after-id and --before-id are mutually exclusive. With",
    ...
    "                          [--actor-id-not <uuid>] [--kind <event-kind>]",
    "                          [--after-id <uuid>] [--before-id <uuid>]",
    "                          [--range <after-id>..<before-id>]",
    ...
    "                          OR-semantic multi-value filters. --after-id cursors forward,",

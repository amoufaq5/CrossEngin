...
export function helpText(): string {
  return [
    ...
    "                          --kind-not is repeatable — assert NEITHER event has any of",
    "                          the listed event_kinds; match by either side on any listed",
    "                          kind exits 1 (anti-kind verification, mirror of --kind).",

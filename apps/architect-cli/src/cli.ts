...
export function helpText(): string {
  return [
    ...
    "                          actor; per-side fires independently. With --actor-id-not,",
    "                          assert NEITHER event was authored by that actor; match",
    "                          exits 1 (anti-actor verification). --actor-id-not-a /",

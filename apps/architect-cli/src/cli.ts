...
export function helpText(): string {
  return [
    ...
    "                    [--limit N] [--after-id <uuid>] [--with-actor-names]",
    ...
    "                          With --after-id, paginate forward past the cursor row.",
    "                          --actor-id scopes the log to one actor's mutations.",
    "                          --with-actor-names LEFT JOINs meta.users to surface actor",
    "                          display_name + email alongside raw UUIDs. (requires PG env)",
    ...
    "                          policy_deleted). With --after-id: cursor pagination — walk",
    "                          forward in time starting after that history-event id; output",
    "                          shows nextAfterId when page is full. (requires PG env)",
    ...
    "                          filters to one event_kind. --after-id cursors forward in time.",
    "                          (requires PG env)",

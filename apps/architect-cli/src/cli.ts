...
export function helpText(): string {
  return [
    ...
    "                          to one actor's mutations. --actor-id-not is repeatable and",
    "                          excludes events authored by any of the listed actors (OR-",
    "                          semantic NOT IN; system events with null actor_id are",
    "                          included). --system-only returns ONLY system-authored events",

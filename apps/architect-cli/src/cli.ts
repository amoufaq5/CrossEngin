...
export function helpText(): string {
  return [
    ...
    "                          print the query plan (filters + pagination + output spec)",
    "                          without executing. Debug aid for legitimate empty results",
    "                          and for understanding effective WHERE conditions.",

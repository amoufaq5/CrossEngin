...
export function helpText(): string {
  return [
    ...
    "  --jwt-issuer <iss>      With --jwks-file, expected JWT issuer (required)",
    "  --jwt-audience <aud>    With --jwks-file, expected JWT audience (required)",
    "  --clock-skew-seconds N  With --jwks-file, exp/nbf grace window (default: 30, max: 600)",

...
export function helpText(): string {
  return [
    ...
    "                       [--watch-keep-going] [--threshold-alert <field>:<op><value> ...]",
    ...
    "                          Under --watch, Ctrl-C exits cleanly (PG connection closes",
    "                          via a SIGINT-to-AbortController bridge).",
    ...
    "                          With --threshold-alert <field>:<op><value> (repeatable),",
    ...
    "                          Under --watch, Ctrl-C exits cleanly (graceful PG shutdown via",
    "                          SIGINT-to-AbortController bridge). With --tenant <uuid>,",
    ...
    "                          With --threshold-alert <field>:<op><value> (repeatable), exits",

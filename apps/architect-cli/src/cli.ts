...
export function helpText(): string {
  return [
    ...
    "                          (requires PG env)",
    "  retention summary [--group-by kind|tenant|actor|table] [--tenant <uuid>]",
    "                    [--table <name>] [--kind <event-kind> ...]",
    ...
    "                          {key, count} sorted by count DESC then key ASC, plus a total.",
    "                          --group-by kind groups by event_kind; tenant by tenant_id;",
    "                          actor by actor_id (null actor renders <system>); table by",
    "                          table_name. Accepts the same filters as 'history' (--tenant /",

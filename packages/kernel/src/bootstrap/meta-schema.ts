...
export const META_WORKFLOW_INSTANCES: TableDefinition = {
  ...
  columns: [
    ...
    },
    {
      ...
      notNull: true,
      check:
        "status IN ('created', 'running', 'waiting_for_signal', 'waiting_for_timer', 'waiting_for_activity', 'waiting_for_manual', 'waiting_for_child', 'suspended', 'completed', 'failed', 'cancelled', 'compensating', 'compensated')",
    },
    {
      name: "current_state",
      type: "TEXT",
  ...
  columns: [
    {
      ...
      notNull: true,
      check:
        "table_name IN ('workflow_traces', 'llm_latency_samples', 'llm_call_traces', 'tenant_retention_opt_out_history', 'gateway_pipeline_executions', 'rate_limit_decisions')",
    },
    {
      name: "retention_days",
      type: "INTEGER",
...
export const META_TENANT_RETENTION_POLICIES: TableDefinition = {
  ...
  columns: [
    { name: "tenant_id", type: "UUID", notNull: true, references: TENANT_FK },
    {
      ...
      notNull: true,
      check:
        "table_name IN ('workflow_traces', 'llm_call_traces', 'tenant_retention_opt_out_history', 'gateway_pipeline_executions', 'rate_limit_decisions')",
    },
    {
      name: "retention_days",
      type: "INTEGER",
...
export const META_LLM_CALL_TRACES: TableDefinition = {
  ...
  columns: [
    ...
    { name: "session_id", type: "TEXT", notNull: true },
    {
      ...
      notNull: true,
      check:
        "kind IN ('llm_call_started', 'llm_call_completed', 'llm_call_failed', 'embed_call_started', 'embed_call_completed', 'embed_call_failed', 'ceiling_resolved')",
    },
    { name: "occurred_at", type: "TIMESTAMPTZ", notNull: true },
    {
      name: "duration_ms",

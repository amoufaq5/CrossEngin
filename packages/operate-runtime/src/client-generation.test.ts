...
describe("clientLanguageSupported", () => {
  it("is true for ts/python/go, false for others", () => {
    expect(SUPPORTED_CLIENT_LANGUAGES).toEqual(["typescript", "python", "go", "php", "ruby"]);
    ...
    expect(clientLanguageSupported("ruby")).toBe(true);
...
describe("generateClient", () => {
  for (const language of ["typescript", "python", "go", "php", "ruby"] as const) {
